...
export default function ProfileInfoPills({ age, location, joinDate }: ProfileInfoPillsProps) {
    return (
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-3 pt-2">
            {age && (
                <div className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/[0.03] border border-white/[0.05] rounded-full text-[11px] sm:text-xs font-semibold text-text-main/40">
