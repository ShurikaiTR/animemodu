        ...
        <div className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative group">
                        ...
                        <Input
                            ...
                            readOnly
                            className="pl-10 opacity-50 cursor-not-allowed bg-white/[0.02]"
                        />
                    </div>
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-2">
                ...
                <div className="relative group transition-colors">
                    ...
                    <Input name="email" defaultValue={user.email} readOnly className="pl-10 opacity-50 cursor-not-allowed bg-white/[0.02]" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <div className="relative group focus-within:text-primary transition-colors">
                        ...
                        <Input name="location" defaultValue={user.location || ""} className="pl-10" placeholder="İstanbul, TR" />
                    </div>
                </div>
                <div className="space-y-2">
                    ...
                    <div className="relative group focus-within:text-primary transition-colors">
                        ...
                        <Input name="age" defaultValue={user.age || ""} className="pl-10" placeholder="24" />
                    </div>
                </div>
            </div>
