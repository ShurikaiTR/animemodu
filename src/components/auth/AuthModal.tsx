...
export default function AuthModal({ isOpen, onClose, initialView = "login" }: AuthModalProps) {
    ...
    return createPortal(
        ...
        >
            <div
                className="bg-[#12141a] w-full max-w-4xl h-[600px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl flex relative animate-in zoom-in-95 duration-300 cursor-auto"
