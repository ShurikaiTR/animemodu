...
export default function Navigation({ isMobileMenuOpen }: NavigationProps) {
    return (
        <ul className={cn(
            "fixed left-0 w-full bg-bg-main border-b border-bg-secondary z-[100] transition-all duration-500 flex flex-col justify-start items-start p-5 overflow-y-auto h-[250px]",
            isMobileMenuOpen ? "top-0 opacity-100 visible" : "-top-[250px] opacity-0 invisible",
            ...
            <li className="relative mb-5 xl:mb-0 xl:mr-[60px] w-full xl:w-auto">
                <Link
                    href="/"
