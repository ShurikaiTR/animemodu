        ...
        <div className="space-y-6">
            <div className="space-y-2">
                ...
                <div className="relative group focus-within:text-white transition-colors">
                    ...
                    <Input name="social_x" defaultValue={user.socials?.x} variant="modal" className="pl-10 focus:border-white/50" placeholder="kullaniciadi" autoComplete="off" />
                </div>
            </div>
            <div className="space-y-2">
                ...
                <div className="relative group focus-within:text-instagram transition-colors">
                    ...
                    <Input name="social_instagram" defaultValue={user.socials?.instagram} variant="modal" className="pl-10 focus:border-instagram/50" placeholder="kullaniciadi" />
                </div>
            </div>
            <div className="space-y-2">
