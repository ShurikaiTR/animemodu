        ...
        <div className="space-y-6">
            <div className="space-y-2">
                ...
                <div className="relative group focus-within:text-twitter transition-colors">
                    ...
                    <Input defaultValue={user.socials?.twitter} variant="modal" className="pl-10 focus:border-twitter/50" placeholder="https://twitter.com/..." />
                </div>
            </div>
            <div className="space-y-2">
                ...
                <div className="relative group focus-within:text-instagram transition-colors">
                    ...
                    <Input defaultValue={user.socials?.instagram} variant="modal" className="pl-10 focus:border-instagram/50" placeholder="https://instagram.com/..." />
                </div>
            </div>
            <div className="space-y-2">
                ...
                <div className="relative group focus-within:text-white transition-colors">
                    ...
                    <Input defaultValue={user.socials?.github} variant="modal" className="pl-10 focus:border-white/50" placeholder="https://github.com/..." />
                </div>
            </div>
            <div className="space-y-2">
                ...
                <div className="relative group focus-within:text-primary transition-colors">
                    ...
                    <Input defaultValue={user.socials?.website} variant="modal" className="pl-10 focus:border-primary/50" placeholder="https://..." />
                </div>
            </div>
        </div>
    );
